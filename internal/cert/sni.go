...
// exactly the hosts isola routes on.
//
...
// to the hosts isola routes ("localhost" and "<slug>.localhost"); any other
...
func NewSNIGetCertificate(paths CertPaths) (func(*tls.ClientHelloInfo) (*tls.Certificate, error), error) {
	...
	return func(hello *tls.ClientHelloInfo) (*tls.Certificate, error) {
		// Only mint for hosts isola actually serves. Empty SNI (a client

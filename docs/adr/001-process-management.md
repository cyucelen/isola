...
isola needs to start and manage multiple development servers across git worktrees. There are several approaches to process management:
...
- **Orphan processes** - If isola crashes, processes may be left running (mitigated by PID tracking)
